...
<template>
    <div class="login-form  flex flex-col justify-center items-center">
      <h2 class="text-white font-extrabold text-2xl mb-12">Sign-Up</h2>

   <form  @submit="handleRegister" className="sm:w-[45%] w-[45%] px-4 lg:px-0 mx-auto">
    <div className="pb-2 pt-4 rounded-md">
              <input      type="username"
            placeholder="Username"
            name="username"
         class="form-control block w-full p-4 text-lg rounded-sm"
              />
          </div>
          <div className="pb-2 pt-4 rounded-md">
              <input  type="email"
          ...
          <div className="px-4 pb-2 pt-4">
            ...
            type="submit"
                  ...
                  className="uppercase block w-full p-4 text-lg rounded-full bg-blue-500 text-white  focus:outline-none"
              >
                  Login
              </button>
          </div>
